                        ...
                        <nav id="mainnav" class="mainnav">
                            <ul class="menu">
                                <li class="active">
                                    ...
                                    <!--<ul class="submenu">
                                        <li class="active"><a href="index.html">Homepage Style</a></li>                                                                      
                                    </ul>-->
                                </li>
                                <li>
                                    <a href="shop-3col.html" download="">SHOP</a>
                                    <ul class="submenu">
                                        <li>
                                            <a href="shop-3col-slide.html" download="">Shop Layouts</a>
                                        </li>
                                        <li>
                                            <a href="shop-detail-des.html" download="">Shop Details</a>
                                            <ul class="submenu">
                                ...
                                <li>
                                    <a href="coming-soon.html" download="">PAGE</a>
                                    <ul class="submenu">
                                        <li><a href="coming-soon.html">Coming Soon</a></li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="blog-list.html" download="">BLOG</a>
                                    <ul class="submenu">
                                ...
                                <li>
                                    <a href="contact.html" download="">CONTACT</a>
