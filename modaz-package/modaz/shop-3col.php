                ...
                <div class="container-fluid clearfix container-width-93" id="site-header-inner">
                    <div id="logo" class="logo float-left">
                        <a href="index.html" title="logo">
                            <img src="images/z4152026595126_6236ec80d20bd2b4b081c83ce309c3f3-removebg-preview.png" alt="image" width="180" height="70">
                    </div><!-- /.logo -->
                        ...
                        <nav id="mainnav" class="mainnav">
                            <ul class="menu">
                                <li>
                                    ...
                                    <!--<ul class="submenu">
                                        <li><a href="index.html">Homepage Style </a></li>                                    
                                    </ul>-->
                                </li>
                                <li class="active">
    				...
    				<div class="col-md-12">
    					...
    					<div class="breadcrumbs">
    						<ul>
    							...
    							<li><a href="shop-3col.php">Shop</a></li>
                                <li><a href="shop-3col.php">Sale Shop</a></li>
    						</ul>
    					</div><!-- /.breadcrumbs -->
    				</div><!-- /.col-md-12 -->
    			</div><!-- /.row -->
                            ...
                            <ul class="product">
                                <li class="product-item">
                                    <div class="product-thumb clearfix">
                                        <a href="#">
                                            <img src="images/products/prd1.jpg" alt="image">
                                        </a>
                                    ...
                                    <div class="product-info clearfix">
                                        ...
                                        <div class="price">
                                            <del>
                                                <span class="regular">$2400.00</span>
                                            </del>
                                            <ins>
                                ...
                                <li class="product-item">
                                    <div class="product-thumb clearfix">
                                        <a href="#">
                                            <img src="images/products/prd2.jpg" alt="image">
                                        </a>
                                        <span class="new sale">Sale</span>
                                    </div>
                                    <div class="product-info clearfix">
                                        ...
                                        <div class="price">
                                            <del>
                                                <span class="regular">$3000.00</span>
                                            </del>
                                            <ins>
                                ...
                                <li class="product-item">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="images/products/prd3.jpg" alt="image">
                                        </a>
                                        <span class="new sale">Sale</span>
                                    </div>
                                    <div class="product-info clearfix">
                                        ...
                                        <div class="price">
                                            <del>
                                                <span class="regular">$1800.00</span>
                                            </del>
                                            <ins>
                                ...
                                <li class="product-item">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="images/products/prd5.jpg" alt="image">
                                        </a>
                                        <span class="new sale">Sale</span>
                                    </div>
                                    <div class="product-info clearfix">
                                        ...
                                        <div class="price">
                                            <del>
                                                <span class="regular">$4200.00</span>
                                            </del>
                                            <ins>
                                ...
                                <li class="product-item">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="images/products/prd6.jpg" alt="image">
                                        </a>
                                        <span class="new sale">Sale</span>
                                    </div>
                                    <div class="product-info clearfix">
                                ...
                                <li class="product-item">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="images/products/prd7.jpg" alt="image">
                                        </a>
                                        <span class="new sale">Sale</span>
                                    </div>
                                    <div class="product-info clearfix">
                                        ...
                                        <div class="price">
                                            <del>
                                                <span class="regular">$4800.00</span>
                                            </del>
                                            <ins>
                                ...
                                <li class="product-item">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="images/products/prd8.jpg" alt="image">
                                        </a>
                                        <span class="new sale">Sale</span>
                                    </div>
                                    <div class="product-info clearfix">
                                ...
                                <li class="product-item">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="images/products/prd9.jpg" alt="image">
                                        </a>
                                        <span class="new sale">Sale</span>
                                    </div>
                                    <div class="product-info clearfix">
                                ...
                                <li class="product-item">
                                    <div class="product-thumb clearfix">
                                        <a href="#" class="product-thumb">
                                            <img src="images/products/product.jpg" alt="image">
                                        </a>
                                        <span class="new sale">Sale</span>
                                    </div>
                                    <div class="product-info clearfix">
                                        ...
                                        <div class="price">
                                            <del>
                                                <span class="regular">$3300.00</span>
                                            </del>
                                            <ins>
					...
					<div class="col-md-8">
						<div class="subscribe clearfix">
							...
							<ul class="flat-social">
								<li><a href="https://www.facebook.com/profile.php?id=100090968866398"><i class="fa fa-facebook"></i></a></li>
				...
				<div class="row">
                    <div class="col-md-3">
                        <div class="widget widget-link link-map">
                            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3724.09798860926!2d105.77960061501275!3d21.028764885998417!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x313454b3285df81f%3A0x97be82a66bbe646b!2sDetech%20Building!5e0!3m2!1sen!2s!4v1678266858974!5m2!1sen!2s" width="500" height="200" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                        </div>
                    </div>
					<div class="col-md-3">
					...
					<div class="col-md-3">
						<div class="widget widget-brand">
							<div class="logo logo-footer">
								<a href="index.php"><img src="images/z4152026595126_6236ec80d20bd2b4b081c83ce309c3f3-removebg-preview.png" alt="image" width="140" height="40"></a>
							</div>
                            <ul class="flat-contact">
								<li class="address">8A Ton That Thuyet, Ha Noi</li>
								<li class="phone">+378856272</li>
