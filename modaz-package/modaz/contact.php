...
<head>
    ...
    <title>BagBag HTML Template</title>
                        ...
                        <nav id="mainnav" class="mainnav">
                            <ul class="menu">
                                ...
                                <li>
                                    ...
                                    <ul class="submenu">
                                        ...
                                        <li>
                                            ...
                                            <ul class="submenu">                                            
                                                <li><a href="shop-detail-zoom.php">Details Zoom</a></li>
                                                <li><a href="shop-detail-video.php">Details Video</a></li>                                               
                                            </ul>
                                        </li>
                                    </ul>
                                </li>
                                ...
                                <li >
                                    ...
                                    <ul class="submenu">
                                        <li ><a href="blog-list.php">Blog List Full</a></li>
                    ...
                    <div class="col-md-4">
                        <div class="iconbox text-center">
                            ...
                            <div class="box-content">
                                <p>Detech Building, 8A Ton That Thuyet, Ha Noi</p>
                            </div><!-- /.box-content -->
                        </div><!-- /.iconbox -->
                    </div><!-- /.col-md-4 -->
                    <div class="col-md-4">
